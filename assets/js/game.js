...
var fightOrSkip = function() {
    ...
    if (promptFight === "skip") {
        ...
        if (confirmSkip) {
            ...
            //return false if player doesn't want to leave
            return false;
    }
}
...
var fight = function(enemy) {
    ...
    while (playerInfo.health > 0 && enemy.health > 0) {
        ...
        // generate random health value based on enemy's attack power
...
var endGame = function() {
    ...
    // chec localStorage for high score, if it's not there, use 0
...
var getPlayerName = function() {
    ...
    // for(var i = 0; i < getPlayerName.length; i++)
    // prompt here
